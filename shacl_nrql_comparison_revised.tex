...
A genuine quantitative figure would require coding a corpus---e.g.\ the \shacl{} test suite, or a sample of published shapes graphs---against Table~\ref{tab:translation} under an explicit regime, and reporting inter-coder agreement. We mark that as the right future-work experiment and decline to pre-empt its result with a guess.
