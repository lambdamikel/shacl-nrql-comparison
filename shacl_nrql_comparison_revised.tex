...
A genuine quantitative figure would require coding a corpus---e.g.\ the \shacl{} test suite, or a sample of published shapes graphs---against Table~\ref{tab:translation} under an explicit regime, and reporting the coding openly. We carry out exactly this experiment for the W3C \shacl{} test suite in \S\ref{sec:empirical}.
