...
\begin{itemize}[leftmargin=2em]
  ...
  \item \textbf{N} (native residual): outside the nonrecursive \naf{}-plus-projection fragment (unbounded or recursive paths; recursion) \emph{or} beyond RacerPro's predicate vocabulary (\texttt{sh:pattern} regular expressions);
...
N & Native residual (paths + \texttt{sh:pattern} regex) & 7 & 7.4 \\
